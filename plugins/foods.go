...
var foodCategories = []string{
	...
	"chinese", "cantonese", "mandarin", "sichuan", "hunan", "shanghai", "beijing", "dongbei", "yunnan", "xinjiang",
	"indian", "thai", "mexican", "italian", "mediterranean", "american",
...
func (p *Foods) Init(c bot.PluginConfig, _ *storage.DB) error {
	...
	p.aliases = map[string]string{
		...
		"cantonese": "cantonese", "canton": "cantonese", "粤菜": "cantonese", "mandarin": "mandarin", "northern-chinese": "mandarin",
		"sichuan": "sichuan", "szechuan": "sichuan", "chuan": "sichuan", "hunan": "hunan", "xiang": "hunan",
		"shanghai": "shanghai", "shanghainese": "shanghai", "beijing": "beijing", "peking": "beijing",
		"dongbei": "dongbei", "northeastern-chinese": "dongbei", "yunnan": "yunnan", "xinjiang": "xinjiang",
...
func (p *Foods) addFallbacks() {
	fallbacks := map[string][]string{
		...
		"cantonese":      {"dim sum", "char siu", "wonton noodles", "cheung fun"},
		"mandarin":       {"jiaozi", "zhajiangmian", "peking duck", "scallion pancakes"},
		"sichuan":        {"mapo tofu", "kung pao chicken", "dan dan noodles", "fish-fragrant eggplant"},
		"hunan":          {"chairman mao's braised pork", "steamed fish head with chili", "rice noodles", "orange beef"},
		"shanghai":       {"xiaolongbao", "shengjian mantou", "Shanghai braised pork", "scallion oil noodles"},
		"beijing":        {"Peking duck", "zhajiangmian", "jiaozi", "Beijing hot pot"},
		"dongbei":        {"guo bao rou", "di san xian", "suan cai bai rou", "东北 dumplings"},
		"yunnan":         {"crossing-the-bridge noodles", "yunnan mushroom hot pot", "er kuai", "pounded potato"},
		"xinjiang":       {"xinjiang lamb skewers", "da pan ji", "laghman noodles", "naan"},
